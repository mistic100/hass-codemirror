...
export async function restartHomeAssistant() {
    const confirmed = await showConfirmDialog({
        ...
        message: "Are you sure you want to restart Home Assistant? CodeMirror will be unavailable until the restart completes.",
        confirmText: "Restart",
        cancelText: "Cancel",
        isDanger: true
    });
            ...
            if (data.success) {
                ...
                const checkOnline = async () => {
                    try {
                        ...
                        if (data) {
                            console.log("CodeMirror: Server is back online, reloading workspace in 2 seconds...");
