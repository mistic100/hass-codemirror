/**
 * ============================================================================
 * HOME ASSISTANT AUTOCOMPLETE MODULE
 * ============================================================================
 *
 * PURPOSE: Home Assistant entity autocomplete and YAML schema hints.
 * Provides intelligent autocomplete for HA entity IDs, services, domains.
 *
 * EXPORTED FUNCTIONS:
 * - loadEntities() - Load HA entities from server
 * - homeAssistantHint(cm, options) - CodeMirror autocomplete hint function
 *
 * HOW TO ADD FEATURES:
 * 1. Add service autocomplete: Suggest services based on domain
 * 2. Add attribute hints: Suggest entity attributes
 * 3. Add template helpers: Autocomplete Jinja2 template functions
 * 4. Add schema validation: Validate YAML against HA schema
 *
 * INTEGRATION: editor.js (CodeMirror), api.js, constants.js
 * ============================================================================
 */
